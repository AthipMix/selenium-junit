...
class SeleniumJunitTest {
    ...
    @Test
    void tc_101_search_npru() {
        WebElement searchBox = driver.findElement(By.id("APjFqb"));
        searchBox.sendKeys("NPRU");  
        searchBox.sendKeys(Keys.ENTER);
        
        // แนะนำเพิ่มเติม: ควรใส่ Assertion เพื่อเช็คผลลัพธ์ เช่น เช็ค Title ของหน้าเว็บ
        assertTrue(driver.getTitle().contains("NPRU"));
    }
